...
- **`/delegation:bearings`** — assess a goal from bounded evidence, choose `CONTINUE`,
  ...
  It can render an attended decisions/goals update through the existing writer; it has no
  automatic daily trigger or unattended `Done` pickup.
