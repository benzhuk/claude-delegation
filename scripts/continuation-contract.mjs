...
export const CONTINUATION_EVENTS = Object.freeze(['SessionStart', 'UserPromptSubmit', 'PostToolUse', 'Stop']);
export const CONTINUATION_HOSTS = Object.freeze(['codex', 'claude']);

/**
 * @typedef {Object} ContinuationEvent
 * @property {'codex'|'claude'} host
 * @property {'SessionStart'|'UserPromptSubmit'|'PostToolUse'|'Stop'} event
