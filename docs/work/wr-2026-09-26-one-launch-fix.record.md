...
Artifact: none yet
Evidence: docs/notes/skills-fable-one-launch-fix-1.md (ASK packet, main checkout)
Next: one launch of the one-launch script (build/one-launch-1 55106db) in setup mode, then accept
