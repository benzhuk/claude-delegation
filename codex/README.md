...
`~/.codex/agents/` and publishes `skills/{multi,delegate,team-build,decisions,notion-writing,
dev-server}` (plus the chezmoi-managed `~/.claude/skills/{knowledge,triage,learn}` when
